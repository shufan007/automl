...
class AutoRegressor(BaseTrainer):
    def __init__(self,
                 args,
        ...
        self.larger_better_loss_list = ['r2']
    ...
    def train(self):
        ...
        logger.info('Best hyperparmeter config:{}'.format(self.auto_trainer.best_config))
    ...
    def eval(self):
        ...
        logger.info("Model evaluation on validation dataset")
        from flaml.ml import sklearn_metric_loss_score
        y_pred = self.auto_trainer.predict(X_val)
        logger.info('mae = {}'.format(sklearn_metric_loss_score('mae', y_pred, y_val)))
        logger.info('mape = {}'.format(sklearn_metric_loss_score('mape', y_pred, y_val)))
        logger.info('rmse = {}'.format(sklearn_metric_loss_score('rmse', y_pred, y_val)))
        logger.info('r2 = {}'.format(1 - sklearn_metric_loss_score('r2', y_pred, y_val)))
