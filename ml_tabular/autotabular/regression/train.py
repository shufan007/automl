...
from autotabular.regression.regressors import AutoRegressor
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train a AutoML Regressor')
    # env args
    ...
    parser.add_argument('--metric', type=str, default='r2', choices=['r2', 'rmse', 'mse', 'mae', 'mape'],
...
def train_regressor(args):
    ...
    # train process
    regressor = AutoRegressor(args, train_dataset, val_dataset)
    regressor.train()
